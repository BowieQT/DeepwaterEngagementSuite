    ...
    private void InitOnce()
    {
        if (!_initialized)
        {
            ...
            var defaultChartMods = new List<VoyageChartModifier>
            {
                ...
                new() { Id = "MapDeepwaterChartVoyageSoulEater", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyagePackSize1", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyagePackSize2", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageQuantity1", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageQuantity2", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageRarity1", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageRarity2", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageFriendlyJelly", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageResourceFound1", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageResourceFound2", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageResourceFound3", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageIncreasedRareMonsters", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageIncreasedMagicMonsters", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageNoEquipmentDrops", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageMinimumMagicMonsters", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageMonstersPossessed", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageMonstersEssenced", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageRareFracture", IsGlobal = { Value = true }, },
                new() { Id = "MapDeepwaterChartVoyageFlaskQuality", IsGlobal = { Value = true }, },
            };
